...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:hoZxY8uW+mT+OpkcUWw4k0fDINtOcVavEsGfzwzFU/w=",
        version = "v1.12.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:weq9iSThUSL21SH3VrwoKa2DgRsaYMfjRNX/yOU3Foo=",
        version = "v2.102.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wXCXFmqyY+1RwiKfYo3jMKyrtZmOL3kHwaqDyCPOYak=",
        version = "v1.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wquqUxAFdcUgabAVLvSCOKOlag5cIZuaOjYIBOWdsR0=",
        version = "v0.4.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JML/k+t4tpHCpQTCAD62Nu43NUFzHY4CV3uAuvHGC+Y=",
        version = "v4.18.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3gv/GThfX0cV2lpO7gkTUwZru38mxevy90Bj8YFSRQQ=",
        version = "v0.61.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Df6WuGvthPzc+JiQ/G+m+sNX24kc0aTBqoDN/0yyykE=",
    ...
    go_repository(
        ...
        sum = "h1:QNxhiucJGWLF/fFpnyTIk8GdEGTa6tUC7/JYG7VN3XU=",
    ...
    go_repository(
        ...
        sum = "h1:Y/Mj/94zIQQGHVSv1tTtQBDaQaJe62U9bkDZKKyhPCU=",
    ...
    go_repository(
        ...
        sum = "h1:WqJoPL3x4cUufQVHkXpXX7ThFJ1C4ik80i2eXEXbhD8=",
        version = "v4.23.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:N49a7JiWGWV7lkPE4yYcvjkBGZQi93/JabRYjdWmJXc=",
        version = "v4.23.1",
    )
    go_repository(
        name = "org_modernc_db",
    ...
    go_repository(
        ...
        sum = "h1:bJ9ChznK1L1mUtAQtxi0wi5AtAs5jQuw4PrPHO5pb6M=",
        version = "v2.5.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:wVyqEx6tlltte9lPTjq0kDAdtdM9c4JH8rU6M1ZVawA=",
        version = "v1.61.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:J9n76TPsfYYkFkZ9Uy1QphILYifiVEwwOT7yP5b++2Y=",
        version = "v1.34.2",
    )
    go_repository(
