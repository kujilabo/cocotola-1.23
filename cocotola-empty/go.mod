module github.com/kujilabo/cocotola-1.23/cocotola-empty

go 1.23.3

require (
	github.com/kujilabo/cocotola-1.23/lib v0.0.0-20250216123417-f55168414267
	github.com/kujilabo/cocotola-1.23/redstart v0.0.0-20250216123417-f55168414267
